...
get_input()
draw_sprite(spr_rocketmeter_button, (j_y || (!ui_is_initialized)), (pos_x[2] + 18), (pos_y[2] - 3))
var c = c_white
if ((!global.hot_room) && ((!j_y) || ui_is_initialized))
    c = c_black
draw_set_color(c)
draw_set_halign(fa_center)
draw_text((pos_x[2] + 19), (pos_y[2] - 3 - 7), "Y")
draw_set_halign(fa_left)
draw_set_color(c_white)
if (!global.hot_room)
    draw_text((pos_x[2] - 9), (pos_y[2] + 6), "EJECT")
if get_bitwise_flag(global.abilities, 2)
{
    ...
    draw_sprite(spr_rocketmeter_button, a_press, (pos_x[3] - 14), (pos_y[3] - 13))
    draw_set_halign(fa_center)
    c = c_black
    if a_press
        c = c_white
    draw_set_color(c)
    draw_text((pos_x[3] - 13), (pos_y[3] - 13 - 7), "A")
    draw_set_halign(fa_left)
    draw_set_color(c_white)
}
if get_bitwise_flag(global.abilities, 4)
{
    ...
    draw_sprite(spr_rocketmeter_button, b_press, (pos_x[4] - 1), (pos_y[4] - 2))
    draw_set_halign(fa_center)
    c = c_black
    if b_press
        c = 16777215
    draw_set_color(c)
    draw_text(pos_x[4], (pos_y[4] - 9), "R")
    draw_set_halign(fa_left)
    draw_set_color(c_white)
}
