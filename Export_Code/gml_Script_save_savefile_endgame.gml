...
ds_map_set(map, "map_start", "map6")
ds_map_set(map, "room_start", "2522")
ds_map_set(map, "palette_id", global.palette_default)
ds_map_set(map, "spawn_x", string(56))
ds_map_set(map, "spawn_y", string(152))
ds_map_set(map, "hassuit", "no")
